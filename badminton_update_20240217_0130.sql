...
INSERT INTO `activity` (`activity_id`, `activity_name`, `activity_desc`, `activity_start_time`, `activity_end_time`, `create_date`, `edit_date`, `create_by`, `edit_by`, `del`) VALUES
...
CREATE TABLE `advertise` (
  ...
  `advertise_desc` varchar(1024) NOT NULL,
  `advertise_start_time` datetime NOT NULL,
  `advertise_end_time` datetime NOT NULL,
  `create_date` datetime NOT NULL,
  `edit_date` datetime NOT NULL,
  `create_by` int(11) NOT NULL,
  `edit_by` int(11) NOT NULL,
...
CREATE TABLE `facilities` (
  ...
  `facilities_desc` varchar(1024) NOT NULL,
  `facilities_start_time` datetime NOT NULL,
  `facilities_end_time` datetime NOT NULL,
  `create_date` datetime NOT NULL,
  `edit_date` datetime NOT NULL,
  `create_by` int(11) NOT NULL,
  `edit_by` int(11) NOT NULL,
...
CREATE TABLE `rules` (
  ...
  `rules_desc` varchar(1024) NOT NULL,
  `rules_start_time` datetime NOT NULL,
  `rules_end_time` datetime NOT NULL,
  `create_date` datetime NOT NULL,
  `edit_date` datetime NOT NULL,
  `create_by` int(11) NOT NULL,
  `edit_by` int(11) NOT NULL,
...
--
ALTER TABLE `facilities`
  MODIFY `facilities_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `facilities`
  ADD CONSTRAINT `facilities_ibfk_1` FOREIGN KEY (`facilities_id`) REFERENCES `image` (`activity_id`);
