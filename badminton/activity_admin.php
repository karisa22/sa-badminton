...
<body>
    ...
    <div class="container">
            ...
            <div class="col-12">
                <form action="upload_activity.php" method="POST" enctype="multipart/form-data">
                    <div class="text-center justify-content-center align-items-center p-4 border-2 border-dashed rounded-3">
                        ...
                        <br>
                         <input type="submit" name="submit" value="upload" class="btn btn-sm btn-primary" style = "float:right;">
                    </div>
        ...
        <div class="row g-2">
            <?php 
                $query = $db->query("SELECT * FROM activity ORDER BY uploaded_on DESC");
                if ($query->num_rows > 0) {
                    while($row = $query->fetch_assoc()) {
                        $imageURL = 'uploads/'.$row['activity_name'];
                    ?>
                    <div class="col-sm-4">
                        <div>
