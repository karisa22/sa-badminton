...
<body>
    ...
    <div class="container">
        <div class="row mt-2">
            <div class="col-12">
                <form action="upload_advertise.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-sm-flex justify-content-end">
                        <input type="submit" name="submit_advertise" value="Upload" class="btn btn-sm btn-primary">
