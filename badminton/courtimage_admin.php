...
<body>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-12">
                <form action="upload_courtimage.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-sm-flex justify-content-end">
                        <input type="submit" name="submit_courtimage" value="Upload" class="btn btn-sm btn-primary">
        ...
        <div class="row g-2">
            <?php 
                $query = $db->query("SELECT * FROM courtimage ORDER BY uploaded_on DESC");
                if ($query->num_rows > 0) {
                    while($row = $query->fetch_assoc()) {
                        $imageURL = 'uploads/'.$row['courtimage_name'];
                    ?>
                    <div class="col-sm-4">
                        <div>
