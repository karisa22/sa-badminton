...
<nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="197">
    <div class="navbar">
      ...
      <div class="nav-links">
        ...
        <ul class="links">
          <li><a href="homeadmin.php">หน้าแรก</a></li>
          <li>
            <a href="#">เกี่ยวกับสนาม</a>
            <i class='bx bxs-chevron-down htmlcss-arrow arrow  '></i>
            <ul class="htmlCss-sub-menu sub-menu">
              <li><a href="#">ข้อมูลสนาม</a></li>
              <li><a href="advertise_admin.php">ข่าวสาร</a></li>
              <li><a href="activity_admin.php">กิจกรรม</a></li>
              <li><a href="rules_admin.php">กฏการใช้สนาม</a></li>
              <li><a href="facilities_admin.php">สิ่งอำนวยความสะดวก</a></li>
          ...
          <i class='bx bxs-chevron-down js-arrow arrow '></i>
            <ul class="js-sub-menu sub-menu">
              ...
              <li><a href="showprofile.php">ข้อมูลผู้ใช้</a></li>
              <li><a href="logout.php">ออกจากระบบ</a></li>
            </ul>
          </li>
          <li><a href="contact_admin.php">ติดต่อผู้ให้บริการ</a></li>
